        ...
        <div className="mb-3">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-2 py-1 bg-green-600 text-white rounded hover:bg-green-700 focus:ring-2 focus:ring-green-200"
            >
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className={`text-lg font-bold ${item.dday.color}`}>
                      {item.dday.isPast ? (
