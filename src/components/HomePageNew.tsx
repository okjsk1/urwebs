  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="relative bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 text-center py-16 sm:py-24 md:py-32">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105 text-base sm:text-lg flex items-center gap-2 mx-auto"
          >
      ...
      <div className="bg-gray-50 dark:bg-gray-800 py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {/* 날씨 위젯 */}
            <div
              className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-shadow cursor-pointer group overflow-hidden flex flex-col"
              onClick={() => navigate('/mypage')}
            >
