...
export const websites: Website[] = [
  ...
  { category: '테스트 프레임워크', title: 'Robot Framework', url: 'https://robotframework.org', description: '파이썬 기반 키워드 드리븐', id: 'QA-FRM-004' },
  { category: '테스트 프레임워크', title: 'Jest', url: 'https://jestjs.io', description: '자바스크립트 단위 테스트', id: 'QA-FRM-005' },
  ...
  { category: '버그 트래킹', title: 'YouTrack', url: 'https://www.jetbrains.com/youtrack', description: 'JetBrains 이슈 트래커', id: 'QA-BUG-004' },
  { category: '버그 트래킹', title: 'Bugzilla', url: 'https://www.bugzilla.org', description: 'Mozilla 오픈소스 버그 추적', id: 'QA-BUG-005' },
  ...
  { category: 'QA 커뮤니티', title: 'Ministry of Testing', url: 'https://www.ministryoftesting.com', description: 'QA 뉴스·교육·커뮤니티', id: 'QA-COM-004' },
  { category: 'QA 커뮤니티', title: 'Reddit r/QualityAssurance', url: 'https://www.reddit.com/r/QualityAssurance', description: '레딧 QA 토론', id: 'QA-COM-005' },
];
