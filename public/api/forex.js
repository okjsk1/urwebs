// 환율 API 프록시 서버 (Vercel/Netlify Functions 호환)
// 실제 배포 시에는 서버리스 함수로 배포해야 함
...
// 한국수출입은행 API 키 (실제 배포 시 환경변수로 설정)
const KOREA_EXIM_API_KEY = 'DmDlLpOj8J0F2zqE1mXgWLMzQOFxv8k8';
